...
def main():
    ...
    for i, gt_pose in enumerate(tqdm(vo.gt_poses, unit="pose")):
        if i == 0:
            cur_pose = gt_pose # the first pose is from gt
        else:
        ...
        print('predict: ',(cur_pose[0, 3], cur_pose[2, 3], cur_pose[1, 3]))
    plotting.visualize_paths(gt_path, estimated_path, "Visual Odometry", file_out=os.path.basename(data_dir) + method + ".html")
